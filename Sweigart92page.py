...
# 13. Короткие программы для вывода цифр от 1 до 10 с помощью for. Затем while
...
# 15. Поищите в Интернете информацию о функциях round() и abs() и выясните, что они делают. Самостоятельно
# поэкспериментируйте с ними в интерактивной оболочке.

print(round(1.5))  # Стандартная функция для округления числа до ближайщего целого.

print(round(1.4))

print(abs(5))  # Модулем неотрицательного числа a называют само это число а
print(abs(-5))
print(abs(5.5))
print(abs(-7.5))
